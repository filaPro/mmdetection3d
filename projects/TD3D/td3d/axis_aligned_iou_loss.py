...
# This file is an exact copy of projects/TR3D/tr3d/axis_aligned_iou_loss.py
...
class TD3DAxisAlignedIoULoss(nn.Module):
    ...
    def __init__(self,
        ...
        super(TD3DAxisAlignedIoULoss, self).__init__()
